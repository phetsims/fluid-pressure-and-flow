...
define( require => {
  ...
  class MysteryPoolView extends SquarePoolView {
    ...
    constructor( mysteryPoolModel, modelViewTransform, bounds, bottom, left, fluidDensityTop, fluidDensityLeft, width ) {
      ...
      ], mysteryPoolModel.customFluidDensityProperty, this, {
      ...
      ], mysteryPoolModel.customGravityProperty, this, {
        cornerRadius: 8,
        highlightFill: 'rgb(218,255,255)',
        visible: false
      } );
  ...
  return fluidPressureAndFlow.register( 'MysteryPoolView', MysteryPoolView );
} );