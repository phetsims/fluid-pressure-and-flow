...
define( function( require ) {
  ...
  function FlowRuler( isRulerVisibleProperty, rulerPositionProperty, measureUnitsProperty, modelViewTransform, dragBounds, options ) {
    ...
    // ruler in meters
    var metersRuler = new RulerNode( rulerHeight, rulerWidth, meterMajorStickWidth, _.range(6), units_metersString,
      {minorTicksPerMajorTick: 4, unitsFont: scaleFont, majorTickFont: scaleFont, unitsSpacing: 54, rotation: -Math.PI / 2, insetsWidth: 0} );
    this.addChild( metersRuler );

    // ruler in feet
    var feetRuler = new RulerNode( rulerHeight, rulerWidth, feetMajorStickWidth, _.range(17), units_feetString,
      {minorTicksPerMajorTick: 4, unitsSpacing: 14, unitsFont: scaleFont, majorTickFont: scaleFont, insetsWidth: 0, rotation: -Math.PI / 2} );
