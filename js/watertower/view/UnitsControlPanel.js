...
define( function( require ) {
  ...
  function UnitsControlPanel( measureUnitsProperty, width, options ) {
    ...
    var titleText = new Text( unitsString, {font: new PhetFont( 14 ), top: 10, x: width / 2} );
    var metricRadio = new AquaRadioButton( measureUnitsProperty, 'metric', new Text( metricString, textOptions ), {radius: 8, x: 20, y: 35} );
    var englishRadio = new AquaRadioButton( measureUnitsProperty, 'english', new Text( englishString, textOptions ), {radius: 8, x: 20, y: 60} );
    ...
    var content = new VBox( {
      spacing: 10,
      children: [createTitle( titleText ), metricRadio, englishRadio],
      align: 'left'
    } );
